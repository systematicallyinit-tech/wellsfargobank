    ...
    <div className="w-full">
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              >
                Send money internationally to a
                beneficiary bank account. Enter the
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-[10px]">
              Your transfer information has been
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              `linear-gradient(135deg, ${THEME.dark} 0%, ${THEME.primary} 100%)`,
          }}
        >
          {/* Decorative circles */}
        ...
        >
          ...
          <div className="mb-8">
            <SectionHeader
              ...
              description="Provide the recipient's international banking details."
            />
          ...
          <div className="mb-7">
            <SectionHeader
              ...
              description="Specify the transfer amount and purpose."
            />
          ...
          {!submitted && (
            ...
            >
              ...
              <div>
                ...
                >
                  Make sure the beneficiary's
                  country, bank name, account
                  number or IBAN, SWIFT/BIC
                  code, routing number and bank
          ...
          >
            ...
            >
              Your transfer information is
              protected by Wells Fargo security
              systems.
            </p>
          </div>
